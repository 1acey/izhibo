...
public class JWTBaseModel {
    ...
    public Boolean checkTokenValid() {
        this.headerAndPayLoadByAlg = CommonUnits.getStrByAlg_HS256(getHeaderAndPayloadStr(), Constants.JWT_SECERT);
    ...
    public Boolean checkTokenIsExpired() {
        this.jwtPayLoad =(JWTPayLoad) CommonUnits.getObjectFromStrByBased64(getPayLoadStr());
